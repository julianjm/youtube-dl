...
class EhfTvIE(InfoExtractor):
    _VALID_URL = r'https?://(?:www\.)?ehftv\.com/(?P<portal>[a-z]+)/(?P<kind>[^/]+)/(?P<slug>[^/?#&]+)'
    _TEST = {
        'url': 'http://www.ehftv.com/es/video/2016-12-11-norway-denmark-fullmatch',
        'info_dict': {
            'id': '704090',
            'display_id': '2016-12-11-norway-denmark-fullmatch',
            'ext': 'flv',
            'title': 'Norwegen - D\u00e4nemark',
            'upload_date': '20161211',
            'uploader': 'EHF - Europ\u00e4ischer Handball Verband',
            'is_live': False,
            'categories': ['Handball'],
        },
        'params': {
